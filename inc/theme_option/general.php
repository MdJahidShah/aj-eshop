...
<div class="container pt-3">
    <div class="ajsquareth-row">
        <div class="col-ajsquareth-paragraph ajsquareth_common">
            ...
            <div id="theme_option_body">
                <div class="main_head_area">
                    <form action="options.php" method="post">
                        ...
                        <input class="btn btn-primary text-white" type="submit" name="submit" value="<?php _e('Save Info','aj-eshop')?>"></input>
                    </form>
                </div>
            </div>
