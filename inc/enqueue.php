<?php
    ...
    function ajsquare_scripts() {
        ...
        wp_enqueue_style('aj-eshop-root-style', get_stylesheet_uri(), array(), '1.0.0');

        // Theme custom style
        wp_enqueue_style('aj-eshop-style', get_template_directory_uri() . '/assets/css/style.css', array(), '1.0.0');
        ...
        wp_enqueue_style('font-awesome', '/assets/css/font-awesome.all.min.css', array(), '6.4.2');
        ...
        // Theme custom style
        wp_enqueue_style('aj-eshop-tools', get_template_directory_uri() . '/assets/css/tools.css', array(), '1.0.0');
        ...
        // Taskly Tools JS (local)
        wp_enqueue_script('Taskly-Tools-script', get_template_directory_uri() . '/assets/js/taskly.script.js', array('jquery'), '1.0.0', true);

        // Custom JS (local)
        wp_enqueue_script('aj-eshop-script', get_template_directory_uri() . '/assets/js/script.js', array('jquery'), '1.1.0', true);
