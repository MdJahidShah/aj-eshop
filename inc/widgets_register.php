...
// Sidebar Widgets Register
    function ajsquare_widgets_init() {
        register_sidebar(array(
            'name'          => __('Right Sidebar', 'aj-eshop'),
            'id'            => 'main-sidebar',
            'description'   => __('Widgets added here will appear in the main sidebar.', 'aj-eshop'),
        ...
        register_sidebar(array(
            'name'          => __('Footer Widgets', 'aj-eshop'),
            'id'            => 'footer-1',
            'description'   => __('Widgets in this area will be shown on all posts and pages.', 'aj-eshop'),
    ...
    //     register_sidebar(array(
    //         'name'          => __('FooterUp Widget Area', 'aj-eshop'),
