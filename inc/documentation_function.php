        ...
        <div class="ajsquareth-wrap">
            <div class="ajsquareth-row">
                <div class="ajsquareth-paragraph ajsquareth_common">
                    ...
                    <br>
                    <ol>
                        <li><?php _e('Log in to your WordPress dashboard.', 'aj-eshop'); ?></li>
                        <li><?php _e('Navigate to "Appearance > Themes".', 'aj-eshop'); ?></li>
                        <li><?php _e('Click "Add New" and upload the theme file.', 'aj-eshop'); ?></li>
                        <li><?php _e('Activate the theme.', 'aj-eshop'); ?></li>
                    </ol>
                    <br>
                    <span class="fs-2"><?php _e('Customization Options', 'aj-eshop'); ?></span>
                    <br>
                    <p><?php _e('You can customize your theme using the WordPress Customizer. Navigate to "Appearance > Customize" and adjust the settings as per your preferences.', 'aj-eshop'); ?></p>
                    <ul>
                        <li><?php _e('Change background color.', 'aj-eshop'); ?></li>
                        <li><?php _e('Adjust typography and text color.', 'aj-eshop'); ?></li>
                        <li><?php _e('Modify layout options.', 'aj-eshop'); ?></li>
                    </ul>
                    <br>
                    <span class="fs-2"><?php _e('Troubleshooting Common Issues', 'aj-eshop'); ?></span>
                    <br>
                    <p><?php _e('If you encounter any problems, please check the following:', 'aj-eshop'); ?></p>
                    <ul>
                        <li><?php _e('Ensure the theme is activated.', 'aj-eshop'); ?></li>
                        <li><?php _e('Verify that all plugins are updated.', 'aj-eshop'); ?></li>
                        <li><?php _e('Check your browser console for errors.', 'aj-eshop'); ?></li>
                    </ul>
                    <br>
                    <span class="fs-2"><?php _e('Frequently Asked Questions (FAQ)', 'aj-eshop'); ?></span>
                    <br>
                    <p><strong><?php _e('How do I install the theme?', 'aj-eshop'); ?></strong><br>
                    <?php _e('Follow the steps in the installation process section above.', 'aj-eshop'); ?></p>
