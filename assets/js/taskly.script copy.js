    // Modal functionality
        ...
        document.querySelectorAll('.tool-btn').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                const card = this.closest('.taskly_tool-card');
        ...
        function loadEMICalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateEMI">Calculate EMI</button>
        ...
        function loadSIPCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateSIP">Calculate Returns</button>
        ...
        function loadQRGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generateQR">Generate QR Code</button>
                    ...
                    <button class="tbtn btn" id="downloadQR" style="display: none;"><i class="fas fa-download"></i> Download QR Code</button>
                </div>
            `;
        ...
        function loadPasswordGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generateBtn">Generate Password</button>
                    
                    <div class="password-display" id="passwordDisplay">
                        Click "Generate Password"
                    </div>
                    
                    <button class="tbtn btn" id="copyBtn"><i class="fas fa-copy"></i> Copy to Clipboard</button>
                </div>
                ...
                <div class="tool-section">
                    ...
                    <div class="tsinput-group">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <button class="tbtn btn" data-format="uppercase">UPPERCASE</button>
                            <button class="tbtn btn" data-format="lowercase">lowercase</button>
                            <button class="tbtn btn" data-format="sentence">Sentence case</button>
                            <button class="tbtn btn" data-format="title">Title Case</button>
                            <button class="tbtn btn" data-format="invert">iNVERT cASE</button>
                            <button class="tbtn btn" data-format="copy">Copy Text</button>
                        </div>
                    </div>
        ...
        function loadLoremGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generateLorem">Generate Text</button>
                    ...
                    <button class="tbtn btn" id="copyLorem">Copy to Clipboard</button>
                </div>
            `;
        ...
        function loadBMICalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateBmi">Calculate BMI</button>
        ...
        function loadAgeCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateAge">Calculate Age</button>
        ...
        function loadUnitConverter() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="convertUnit">Convert</button>
        ...
        function loadBPMTapper() {
            const content = `
                <div class="tool-section">
                    ...
                    <div class="result-box" style="text-align: center; font-size: 2rem; min-height: 100px; display: flex; align-items: center; justify-content: center;">
                        <div id="bpmDisplay">Tap to start</div>
                    </div>
                    
                    <button class="tbtn btn btn-block" id="tapBtn">Tap to the Beat</button>
        ...
        function loadRandomGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generateRandom">Generate</button>
                ...
                <div class="tool-section">
                    ...
                    <div id="stopwatchContent">
                        ...
                        <div class="stopwatch-controls">
                            <button class="tbtn btn" id="startStopwatch">Start</button>
                            <button class="tbtn btn" id="lapStopwatch">Lap</button>
                            <button class="tbtn btn" id="resetStopwatch">Reset</button>
                        </div>
                    ...
                    <div id="timerContent" style="display: none;">
                        ...
                        <div class="stopwatch-controls">
                            <button class="tbtn btn" id="startTimer">Start</button>
                            <button class="tbtn btn" id="pauseTimer">Pause</button>
                            <button class="tbtn btn" id="resetTimer">Reset</button>
                        </div>
                    </div>
                </div>
            `;
        ...
        function loadDateCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateDiff">Calculate Difference</button>
                    ...
                    <button class="tbtn btn btn-block" id="calculateNewDate">Calculate New Date</button>
        ...
        function loadTipCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateTip">Calculate Tip</button>
        ...
        function loadCurrencyConverter() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="convertCurrency">Convert</button>
        ...
        function loadJokeGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="getJoke">Get Joke</button>
                    <button class="tbtn btn" id="copyJoke">Copy Joke</button>
                </div>
            `;
        ...
        function loadQuoteGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <div class="joke-display" id="quoteDisplay">
                        Click "Get Quote" to see an inspirational quote
                    </div>
                    
                    <button class="tbtn btn btn-block" id="getQuote">Get Quote</button>
                    <button class="tbtn btn" id="copyQuote">Copy Quote</button>
                </div>
            `;
            ...
            const content = `
                <div class="tool-section">
                    ...
                    <div class="tsinput-group">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <button class="tbtn btn" data-encode="base64">Base64 Encode</button>
                            <button class="tbtn btn" data-encode="base64decode">Base64 Decode</button>
                            <button class="tbtn btn" data-encode="url">URL Encode</button>
                            <button class="tbtn btn" data-encode="urldecode">URL Decode</button>
                        </div>
                    </div>
                    ...
                    <button class="tbtn btn" id="copyEncoded">Copy Result</button>
                </div>
            `;
            ...
            const content = `
                <div class="tool-section">
                    ...
                    <div class="tsinput-group">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <button class="tbtn btn" id="encodeURL">Encode URL</button>
                            <button class="tbtn btn" id="decodeURL">Decode URL</button>
                        </div>
                    </div>
                    ...
                    <button class="tbtn btn" id="copyURL">Copy Result</button>
                </div>
            `;
        ...
        function loadWaterTracker() {
            const content = `
                <div class="tool-section">
                    ...
                    <div class="water-tracker">
                        ...
                        <button class="tbtn btn" id="addCup">Add Cup</button>
                        <button class="tbtn btn" id="resetWater">Reset</button>
            ...
            for (let i = 0; i < 8; i++) {
                ...
                cup.innerHTML = '<div class="water-fill"></div>';
                cup.dataset.index = i;
            ...
            function updateWaterDisplay() {
                ...
                // Update cup visuals
                const allCups = document.querySelectorAll('.water-cup');
        ...
        function loadCalorieCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateCalories">Calculate Calories</button>
        ...
        function loadColorPalette() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generatePalette">Generate Palette</button>
                    
                    <div class="result-box" style="display: grid; grid-template-columns: repeat(5, 1fr); gap: 10px; padding: 20px;">
                    ...
                    <div class="result-box" id="paletteCodes" style="font-family: monospace; text-align: center;"></div>
                </div>
            `;
        ...
        function loadImageCropper() {
            const content = `
                <div class="tool-section">
                    ...
                    <div id="cropperContainer">
                        <img id="imagePreview" src="" alt="Preview" style="max-height: 400px; display: none;">
                        <div class="crop-controls" style="display: none;">
                            <button class="tbtn btn" id="cropBtn"><i class="fas fa-crop"></i> Crop Image</button>
                            <button class="tbtn btn" id="downloadBtn"><i class="fas fa-download"></i> Download</button>
                        </div>
                    </div>
                    <div id="cropResult" class="result-box" style="display: none;">
            ...
            const cropperContainer = document.querySelector('.crop-controls');
        ...
        function loadLoveCalculator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="calculateLove">Calculate ❤️</button>
                    <div class="result-box" id="loveResult" style="text-align: center; min-height: 80px; margin-top: 20px; font-size: 1.5rem;">
        ...
        function loadExcuseGenerator() {
            ...
            const content = `
                <div class="tool-section">
                    ...
                    <div class="result-box" style="min-height: 100px; font-size: 1.2rem; text-align: center; display: flex; align-items: center; justify-content: center;">
                        Need an excuse? Just click the button!
                    </div>
                    <button class="tbtn btn btn-block" id="excuseBtn">Make Excuse</button>
                </div>
            `;
            modalBody.innerHTML = content;

            const resultBox = modalBody.querySelector('.result-box');
        ...
        function loadRoastGenerator() {
            ...
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="roastBtn">🔥 Roast Me</button>
                </div>
            `;
            modalBody.innerHTML = content;
        ...
        function loadMemeGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="generateMemeBtn">Generate Meme</button>
                    <div style="margin-top: 20px; text-align: center;">
                        ...
                        <a id="downloadMemeLink" class="tbtn btn" style="display: none;" download="meme.png">Download Meme</a>
                    </div>
                </div>
            `;
            modalBody.innerHTML = content;
        ...
        function loadDataMasker() {
            const content = `
                <div class="tool-section">
                    ...
                    <button class="tbtn btn btn-block" id="maskBtn">Apply Mask</button>
                    <div class="result-box" id="maskedResult">Masked result will appear here...</div>
                    <button class="tbtn btn" id="copyMasked"><i class="fas fa-copy"></i> Copy Result</button>
                </div>
            `;
            modalBody.innerHTML = content;
        ...
        function loadEmojiGenerator() {
            const content = `
                <div class="tool-section">
                    ...
                    <div class="result-box" id="emojiDisplay" style="font-size: 4rem; text-align: center; min-height: 120px;">
                        😄
                    </div>
                    <div class="result-box" id="emojiMeaning" style="text-align: center; margin-top: 15px; font-size: 1.2rem;">
                        Smiling Face with Open Mouth
                    </div>
                    <div style="text-align: center; margin-top: 20px;">
                        <button class="tbtn btn" id="generateEmojiBtn"><i class="fas fa-dice"></i> Generate New Emoji</button>
                        <button class="tbtn btn" id="copyEmojiBtn"><i class="fas fa-copy"></i> Copy Emoji</button>
                    </div>
                </div>
            `;
            modalBody.innerHTML = content;
            ...
            const emojis = [
                { emoji: "😄", meaning: "Smiling Face with Open Mouth" },
                { emoji: "😂", meaning: "Face with Tears of Joy" },
                { emoji: "😎", meaning: "Smiling Face with Sunglasses" },
                { emoji: "😢", meaning: "Crying Face" },
                { emoji: "🔥", meaning: "Fire" },
                { emoji: "👍", meaning: "Thumbs Up" },
                { emoji: "🎉", meaning: "Party Popper" },
                { emoji: "🍕", meaning: "Pizza" },
                { emoji: "🐱", meaning: "Cat Face" },
                { emoji: "🚀", meaning: "Rocket" },
                { emoji: "🌈", meaning: "Rainbow" },
                { emoji: "👻", meaning: "Ghost" },
                { emoji: "🍔", meaning: "Hamburger" },
                { emoji: "💥", meaning: "Collision" },
                { emoji: "🍀", meaning: "Four Leaf Clover" },
                { emoji: "❤️", meaning: "Red Heart" },
                { emoji: "🤔", meaning: "Thinking Face" },
                { emoji: "🥳", meaning: "Partying Face" },
                { emoji: "🤖", meaning: "Robot Face" },
                { emoji: "💡", meaning: "Light Bulb" }
            ];
            ...
            function displayRandomEmoji() {
                const { emoji, meaning } = getRandomEmoji();
