    <div class="row col-head py-3">
        ...
        <div class="row imgp_wrap_home-as">
            ...
            <!-- Featured Image -->
            <div class="col-md-12"> <!-- Adjust column width if needed -->
                <figure class="imgp_wrap_home-as">
                    <?php the_post_thumbnail('full', array('class' => 'img-fluid')); ?> <!-- Ensure img-fluid is applied correctly -->
                </figure>
            </div>
        </div>
        <!-- Featured Image Section End -->
        <div class="col-12 post-head-as">
            <!--Post Format-->
            <span>
                <?php 
                    $post_format = get_post_format();
                    if ( $post_format ) {
                        echo '<div class="post-format-label py-1">';
                        echo '<span class="dashicons dashicons-format-' . esc_attr( $post_format ) . '" style="margin-right: 6px;"></span>';
                        echo '</div>';
                    } else {
                        echo '<div class="post-format-label py-1">';
                        echo '<span class="dashicons dashicons-media-text" style="margin-right: 6px;"></span>';
    ...
    <div class="row pt-3" id="aj-squarecontent">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="col-12 author-information py-5 mb-2 bg-light text-dark mt-3">
                <div class="row">
            ...
            <div class="row px-3 pb-3 bg-light" id="post_comments">
