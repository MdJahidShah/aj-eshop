...
<section class="container-fluid px-5 py-3 content-archive author-archive ">
    <div class="row py-3">
        ...
        <div class="col-sm-8" id="archive-content_wrapper">
            <div class="row bg-dark text-white p-4" id="aj-eshop-archive-content">
                <?php if (have_posts()) : ?>
            ...
            <div class="row py-3">
                <?php
                    ...
                    <div class="pagination">
                        ...
                        the_posts_pagination(array(
                            'mid_size' => 2,
                            'prev_text' => __('&larr; Previous', 'aj-eshop'),
                            'next_text' => __('Next &rarr;', 'aj-eshop'),
                        ));
                        ?>
                    </div>
                ...
                <?php else : ?>
                    ...
                    <article id="post-0" class="post no-results not-found">
                        <div class="entry-header">
                            <h2 class="entry-title"><?php _e('Nothing Found', 'aj-eshop'); ?></h2>
                        </div><!-- .entry-header -->

                        <div class="entry-content">
                            <p><?php _e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'aj-eshop'); ?></p>
                            <?php get_search_form(); ?>
                        </div><!-- .entry-content -->
                    </article><!-- #post-0 -->
